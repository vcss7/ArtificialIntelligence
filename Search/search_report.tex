...
\begin{enumerate}
    \item Complete search tree without repeating nodes. Tree starting at
        ...
        \begin{center}
            \begin{tikzpicture}
                \node [style=rect] (0) at (0, 7) {S};
                \node [style=rect] (1) at (-3, 7) {SA};
                \node [style=rect] (2) at (-1.5, 6) {SB};
                \node [style=rect] (3) at (1.5, 6) {SC};
                \node [style=rect] (4) at (3, 7) {SF};
                \node [style=rect] (6) at (-4.5, 6) {SAD};
                \node [style=rect] (8) at (-3, 5) {SBE};
                \node [style=rect] (9) at (0, 5) {SBG};
